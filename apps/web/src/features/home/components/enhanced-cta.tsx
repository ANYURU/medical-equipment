...
export function EnhancedCTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-700 py-16 md:py-20">
      ...
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-4xl text-center text-white">
          ...
          <p className="mt-4 text-lg text-blue-100 md:text-xl">
            Get in touch with our team to discuss your equipment needs and receive a customized
            quote. We're here to support your mission of delivering exceptional healthcare.
          </p>
